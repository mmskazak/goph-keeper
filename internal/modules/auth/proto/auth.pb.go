...
type LoginResponse struct {
	...
	Status  string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`   // Статус выполнения, "success" или "error"
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // Сообщение об ошибке, если статус "error"
	Jwt     string `protobuf:"bytes,3,opt,name=jwt,proto3" json:"jwt,omitempty"`         // JWT токен, если статус "success"
}
...
var file_auth_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6a, 0x77, 0x74, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x22, 0x47, 0x0a, 0x13, 0x52, 0x65, 0x67,
	...
	0x72, 0x64, 0x22, 0x5a, 0x0a, 0x14, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69,
	...
	0x6a, 0x77, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x32, 0x86,
	...
	0x12, 0x45, 0x0a, 0x0c, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
