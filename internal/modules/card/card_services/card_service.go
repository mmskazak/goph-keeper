...
func (cs *CardService) SaveCard(ctx context.Context, dto card_dto.SaveCardDTO) error {
...
func (cs *CardService) GetCard(ctx context.Context, dto card_dto.GetCardDTO) (card_dto.SaveCardDTO, error) {
	var card card_dto.SaveCardDTO
...
func (cs *CardService) UpdateCard(ctx context.Context, dto card_dto.UpdateCardDTO) error {
...
func (cs *CardService) DeleteCard(ctx context.Context, dto card_dto.DeleteCardDTO) error {
...
func (cs *CardService) GetAllCards(ctx context.Context, dto card_dto.GetAllCardsDTO) ([]card_dto.SaveCardDTO, error) {
	var cards []card_dto.SaveCardDTO
